...
%%%%%% タイトル長すぎ問題 %%%%%%%%%
        ...
        \subsection{Expreimantal environment for conducting subject experiments}
                ...
                \fig{maezuri-Haptics_dev.pdf}{width=.9\hsize}{Haptics display device (Left: Vibration, Right: EMS)}
                ...
                \fig{Movement_of_VirtualWingsV2.pdf}{width=.9\hsize}{Movement of Virtual Wings}
