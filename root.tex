...
\section{EXPANSION OF BODY IMAGE}
        ...
        % \subsection{Body image}
                ...
                % Self-ownership is the sensation that one's own body parts belongs to one's own body.  
                % Self-agency is the sensation that one is performing and action by oneself.
                % % and that one is in control of the body parts.  
                % 
                % Self-ownership and Self-agency are closely related to the formation of the body image.  
                ...
                % 
                % \begin{itemize}
                %         \item Feel "wings" that do not originally exist 
                %         % (Ownership)
                %         \item The sensation of "flying with flapping with one's wings" 
                %         % (Agency)
                % \end{itemize}
                % 
        ...
        \subsection{Types of body image expansion}
                % RHI is the illusion that we feel the rubber hand as if it were our own hand.  
        ...
        \subsection{Body image expantion approach}
                ...
                % the sense of having wings, the sense of flying with wings, and the sense of air resistance.  
...
% \section{SUBJECTIVE EVALUATION EXPERIMENT OF BODY IMAGE EXPANTION USING THE PROPOSED METHOD}
        ...
        \subsection{Examination of operation and presentation methods}
                ...
                \subsubsection{Comparison of wings operation methods}
                        ...
                        % , and when the wrist is opened outward, the wings also opens outward, 
                        as shown in Fig. 6.  
